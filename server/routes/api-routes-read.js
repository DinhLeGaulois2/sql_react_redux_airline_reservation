...
module.exports = function (app) {
    ...
    ///////////////////////////////////////////////////////////////
    app.get("/api/get/booking/:id", requireAuth, (req, res, next) => {
    ...
    app.get("/api/get/bookings", requireAuth, (req, res, next) => {
        db.booking.findAll({
            attributes: ['id'],
            order: [['id', 'ASC']]
        })
    ...
    app.get("/api/get/info4Booking", requireAuth, (req, res, next) => {
        let result = []
    ...
    app.get("/api/get/passenger/:id", requireAuth, (req, res, next) => {
        db.passenger.findAll({
    ...
    app.get("/api/get/passengers", requireAuth, (req, res, next) => {
        db.passenger.findAll({
            attributes: ['id', 'firstName', 'lastName', 'phone', 'email', 'address', 'zipcode', 'state', 'city', 'country']
        }).then(data => res.status(200).json(data))
            .catch(next)
